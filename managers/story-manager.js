...
export async function generateScript() {
  ...
  const script_raw = [
    "Title: Curse of F$",
    "[Open with SpongeBob and Patrick at the Krusty Krab]",
    ...
    "Patrick: F$ck!",
    "[SpongeBob rushes to Mr. Krabs for help]",
    ...
    "",
    "[SpongeBob, Patrick, and Sandy set off on an adventure to find the F$cking flower]",
    "",
    "SpongeBob: Look, Patrick! There it is, the F$cking flower!",
    "",
    "Patrick: F$ck! F$ck! F$ck!",
    "",
    "[SpongeBob picks the flower and gives it to Patrick]",
    "",
    "SpongeBob: Here, Patrick, eat this flower. It will break the curse.",
    "",
    "[Patrick eats the flower and suddenly starts speaking normally]",
    "",
    "Patrick: Wow, that was a f$cking crazy adventure!",
    "",
    "SpongeBob: Haha, it sure was, Patrick.",
    "",
    "[They all laugh as the episode ends]",
    "",
    "[End scene]",
  ];
*/
